<div class="span9">
	<div class="content">
		<div class="module">
			...
			<form class="form-horizontal row-fluid" name="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('backend/update_work');?>">
				...
				<div class="control-group">
					<label class="control-label" for="basicinput">Deskripsi : </label>
						<div class="controls">
							<textarea class="span8" rows="8" id="deskripsi" name="deskripsi" alue="<?php echo $deskripsi;?>" ><?php echo $deskripsi;?>
							</textarea>
						</div>
				</div>
				...
				<div class="control-group">
					<div class="controls">
						<button type="submit" class="btn btn-mini btn-inverse">Update </button>
					</div>
				</div>
			</form>
			</div>
